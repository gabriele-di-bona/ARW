...
graphs["Barabasi_Albert"] = {"N_requested":N_requested, "avg_k_requested":4., "graph_dir":graph_dir, "max_tries":1}
# the following entry is actually useless, but this way there are no problems in the function to get the correct graph
graphs["Airports"] = {"N_requested":N_requested, "avg_k_requested":4., "graph_dir":graph_dir, "max_tries":1}

# PARAMETERS
algorithms = ["URW", "MERW", "ARW"]
alpha = 0.1
chosen_dts = [int(1e8),int(1e9),int(1e10)]
num_to_save = 100
types_entropy = [2,3]
